...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({ error: 'Failed to fetch lootbox' }, { status: 500 });
  }
}
...
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json({ error: 'Failed to update lootbox' }, { status: 500 });
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json({ error: 'Failed to delete lootbox' }, { status: 500 });
  }
}
