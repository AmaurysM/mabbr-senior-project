...
const CommunityPage = () => {
  ...
  const fetchSentiment = async () => {
    try {
      ...
      let updatedSentiment: MarketSentiment = {
        bullishCount: 0,
        bearishCount: 0,
        topPicks: [],
        marketTrend: [],
  ...
  // Handle vote submission with localStorage tracking
  const handleVoteSubmit = async (e: React.FormEvent) => {
    ...
    if (!voteData.sentiment) {
      toast.error('Please select your market sentiment');
      return;
    }
  ...
  return (
    <div className="px-8 py-6 w-full h-full max-w-[1920px] mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-6">
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-5 shadow-lg border border-white/10 flex flex-col h-[calc(100vh-180px)]">
