...
const PostsList: React.FC<CommentsListProps> = ({
  ...
  const onLikeComment = async (commentId: string) => {
    ...
    if (isLiked) {
      ...
      updatedLikesCount[commentId] -= 1; // Decrease count
    } else {
      updatedLikes.add(commentId);
      updatedLikesCount[commentId] += 1; // Increase count
    }
    ...
    try {
      ...
      setCommentLikesCount({
        ...commentLikesCount,
        [commentId]: isLiked ? updatedLikesCount[commentId] + 1 : updatedLikesCount[commentId] - 1,
      });
    }
  };
