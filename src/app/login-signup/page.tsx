    ...
    return (
        <div className="relative flex min-h-screen justify-center bg-gray-200 overflow-hidden">
            ...
            <div className="relative w-full min-h-screen flex overflow-hidden">
                {/* Login Form */}
                <div className={`absolute z-10 min-h-screen w-full max-w-md bg-white bg-opacity-70 p-6 shadow-xl backdrop-filter backdrop-blur-lg transition-transform duration-700 ease-[cubic-bezier(0.68,-0.55,0.27,1.55)] ${isLogin ? 'translate-x-0 right-0 {}' : 'translate-x-[100vw] right-0'}`}>
                ...
                {/* Sign Up Form */}
                <div className={`absolute z-10 min-h-screen w-full max-w-md bg-white bg-opacity-70 p-6 shadow-xl backdrop-filter backdrop-blur-lg transition-transform duration-700 ease-[cubic-bezier(0.68,-0.55,0.27,1.55)] ${isLogin ? '-translate-x-[100vw] left-0' : 'translate-x-0 left-0'}`}>
